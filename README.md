...
* **[Prometheus Service Discovery](https://community.hetzner.com/tutorials/prometheus-discovery) — A service discovery build into [Prometheus](https://github.com/prometheus/prometheus) ⭐ 66,224 | 🐛 914 | 🌐 Go | 📅 2026-09-25 to easily discover Hetzner servers (Cloud & Dedicated)**
* **[Kubernetes Cluster Autoscaler](https://github.com/kubernetes/autoscaler) ⭐ 8,980 | 🐛 340 | 🌐 Go | 📅 2026-09-24 — A k8s component that automatically adjusts the size of a Kubernetes Cluster so that all pods have a place to run and there are no unneeded nodes.**
* **[hcloud cli](https://github.com/hetznercloud/cli) ⭐ 1,817 | 🐛 24 | 🌐 Go | 📅 2026-09-24 — hcloud is a command-line interface for interacting with Hetzner Cloud.**
...
* **[hcloud-csi](https://github.com/hetznercloud/csi-driver) ⭐ 798 | 🐛 30 | 🌐 Go | 📅 2026-09-25 — Container Storage Interface driver for Hetzner Cloud**
...
* **[cert-manager Webhook Hetzner](https://github.com/hetzner/cert-manager-webhook-hetzner) ⭐ 72 | 🐛 12 | 🌐 Go | 📅 2026-09-24 — This webhook provides integration between cert-manager and the Hetzner DNS API to handle DNS-01 challenges.**
...
* **[External DNS Hetzner Webhook](https://github.com/hetzner/external-dns-hetzner-webhook) ⭐ 25 | 🐛 10 | 🌐 Go | 📅 2026-09-25 — This webhook provides integration between External DNS and the Hetzner DNS API to manage records automatically.**
* **[Gitlab Fleeting plugin](https://gitlab.com/hetznercloud/fleeting-plugin-hetzner) — A GitLab fleeting plugin for Hetzner Cloud.**

## CLI

* [kOps](https://github.com/kubernetes/kops) ⭐ 16,677 | 🐛 132 | 🌐 Go | 📅 2026-09-25 — Kubernetes Operations (kOps) automates Kubernetes cluster installation, upgrades and management
...
* [purple](https://github.com/erickochen/purple) ⭐ 705 | 🐛 4 | 🌐 Rust | 📅 2026-09-22 — SSH client TUI with built-in Hetzner Cloud sync. Auto-discovers servers, syncs metadata (location, type, image, status), provider tags and stale host detection.
...
* [terraform-hcloud-talos](https://github.com/hcloud-talos/terraform-hcloud-talos) ⭐ 359 | 🐛 14 | 🌐 HCL | 📅 2026-09-25 — Terraform module for creating a Kubernetes cluster with [Talos](https://www.talos.dev/) in the Hetzner Cloud.
...
* [Coder Template](https://github.com/ntimo/coder-hetzner-cloud-template) ⭐ 29 | 🐛 3 | 🌐 HCL | 📅 2024-04-27 — A Terraform template for [Coder](https://github.com/coder/coder) ⭐ 16,688 | 🐛 1,125 | 🌐 Go | 📅 2026-09-25 to setup a cloud instance as dev environment with or without VS Code.
...
* [cluster-api-provider-hetzner](https://github.com/syself/cluster-api-provider-hetzner) ⭐ 1,135 | 🐛 195 | 🌐 Go | 📅 2026-09-25 — Kubernetes Cluster API Provider for consistent deployment and day 2 operations of "self-managed" HA Kubernetes clusters on Hetzner.
* **[hcloud-cloud-controller-manager](https://github.com/hetznercloud/hcloud-cloud-controller-manager) ⭐ 930 | 🐛 43 | 🌐 Go | 📅 2026-09-24 — Kubernetes cloud-controller-manager for Hetzner Cloud**
* **[hcloud-csi](https://github.com/hetznercloud/csi-driver) ⭐ 798 | 🐛 30 | 🌐 Go | 📅 2026-09-25 — Container Storage Interface driver for Hetzner Cloud**
* [hetzner-kube](https://github.com/xetys/hetzner-kube) ⭐ 753 | 🐛 90 | 🌐 Go | 📅 2023-02-25 — This project contains a CLI tool to easily provision kubernetes clusters on Hetzner Cloud.
* [hcloud-kubernetes](https://github.com/hcloud-k8s/terraform-hcloud-kubernetes) ⭐ 709 | 🐛 11 | 🌐 HCL | 📅 2026-09-22 — Terraform Module to Deploy a Highly Available, Production-Ready Talos Kubernetes Cluster on Hetzner Cloud.
...
* [terraform-hcloud-k3s](https://github.com/identiops/terraform-hcloud-k3s) ⭐ 156 | 🐛 9 | 🌐 HCL | 📅 2026-09-16 — Comprehensive module for provisioning a k3s Kubernetes cluster on Hetzner Cloud.
* [hcloud fip controller](https://github.com/cbeneke/hcloud-fip-controller) ⭐ 147 | 🐛 4 | 🌐 Go | 📅 2026-09-24 — Kubernetes controller to (re-)assign floating IPs to Hetzner Cloud instances.
* **[cert-manager Webhook Hetzner](https://github.com/hetzner/cert-manager-webhook-hetzner) ⭐ 72 | 🐛 12 | 🌐 Go | 📅 2026-09-24 — This webhook provides integration between cert-manager and the Hetzner DNS API to handle DNS-01 challenges.**
...
* [gardener-extension-provider-hcloud](https://github.com/23technologies/gardener-extension-provider-hcloud) ⭐ 18 | 🐛 22 | 🌐 Go | 📅 2026-09-24 — Gardener Extension for Hetzner Cloud provider.
...
* [Healthzner Bot](https://github.com/raphaelbernhart/healthznerbot) ⭐ 35 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-24 — A discord bot to get periodically updates of the health status of your hetzner cloud machines.
...
* [VitoDeploy](https://github.com/vitodeploy/vito) ⭐ 3,239 | 🐛 19 | 🌐 PHP | 📅 2026-09-21 — Vito is a self-hosted web application that helps you to manage your servers and deploy your PHP applications into production servers without a hassle.
...
* [DevPod Provider](https://github.com/mrsimonemms/devpod-provider-hetzner) ⭐ 49 | 🐛 3 | 🌐 Go | 📅 2026-03-26 — Run [DevPod](https://github.com/loft-sh/devpod) ⭐ 15,235 | 🐛 53 | 🌐 Go | 📅 2025-11-14 cloud development environments on Hetzner.
