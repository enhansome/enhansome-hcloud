...
* [kOps](https://github.com/kubernetes/kops) ⭐ 16,663 | 🐛 131 | 🌐 Go | 📅 2026-08-19 — Kubernetes Operations (kOps) automates Kubernetes cluster installation, upgrades and management
...
* [terraform-hcloud-kube-hetzner](https://github.com/kube-hetzner/terraform-hcloud-kube-hetzner) ⭐ 3,912 | 🐛 8 | 🌐 HCL | 📅 2026-08-10 — A highly optimized and auto-upgradable, HA-default & Load-Balanced, Kubernetes cluster powered by k3s-on-MicroOS and deployed for peanuts on Hetzner Cloud 🤑 🚀
...
* [prometheus-storagebox-exporter](https://github.com/crstian19/prometheus-storagebox-exporter) ⭐ 48 | 🐛 9 | 🌐 Go | 📅 2026-08-18 — Modern Prometheus exporter for Hetzner Storage Box with comprehensive metrics.
...
* [hicloud](https://github.com/rtulke/hicloud) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-08-18 — aka hetzner interactive cloud is TUI for interacting with Hetzner Cloud by using commands, wizards and tab-completions including resources.
