...
Want to have your project listed? [Open an Issue](https://github.com/hetznercloud/awesome-hcloud/issues/new?assignees=\&labels=\&projects=\&template=new-project.yml\&title=Add+New+Project%3A+%3Cproject-name%3E) ⭐ 1,354 | 🐛 9 | 📅 2026-09-21!
...
* **[hcloud-go](https://github.com/hetznercloud/hcloud-go) ⭐ 510 | 🐛 7 | 🌐 Go | 📅 2026-09-23 — Package hcloud is a library for the Hetzner Cloud API.**
...
* [Hetzner Cloud PHP SDK](https://github.com/lkdevelopment/hetzner-cloud-php-sdk) ⭐ 127 | 🐛 20 | 🌐 PHP | 📅 2026-09-10 — A PHP SDK for the Hetzner Cloud API: docs.hetzner.cloud
...
* **[Prometheus Service Discovery](https://community.hetzner.com/tutorials/prometheus-discovery) — A service discovery build into [Prometheus](https://github.com/prometheus/prometheus) ⭐ 66,247 | 🐛 917 | 🌐 Go | 📅 2026-09-26 to easily discover Hetzner servers (Cloud & Dedicated)**
* **[Kubernetes Cluster Autoscaler](https://github.com/kubernetes/autoscaler) ⭐ 8,981 | 🐛 339 | 🌐 Go | 📅 2026-09-26 — A k8s component that automatically adjusts the size of a Kubernetes Cluster so that all pods have a place to run and there are no unneeded nodes.**
* **[hcloud cli](https://github.com/hetznercloud/cli) ⭐ 1,817 | 🐛 24 | 🌐 Go | 📅 2026-09-25 — hcloud is a command-line interface for interacting with Hetzner Cloud.**
* **[hcloud-cloud-controller-manager](https://github.com/hetznercloud/hcloud-cloud-controller-manager) ⭐ 929 | 🐛 43 | 🌐 Go | 📅 2026-09-24 — Kubernetes cloud-controller-manager for Hetzner Cloud**
...
* [kOps](https://github.com/kubernetes/kops) ⭐ 16,678 | 🐛 129 | 🌐 Go | 📅 2026-09-26 — Kubernetes Operations (kOps) automates Kubernetes cluster installation, upgrades and management
* [vitobotta/hetzner-k3s](https://github.com/vitobotta/hetzner-k3s) ⭐ 3,689 | 🐛 35 | 🌐 Crystal | 📅 2026-08-25 — A CLI tool written in Crystal to quickly create and manage Kubernetes clusters in Hetzner Cloud
* **[hcloud cli](https://github.com/hetznercloud/cli) ⭐ 1,817 | 🐛 24 | 🌐 Go | 📅 2026-09-25 — hcloud is a command-line interface for interacting with Hetzner Cloud.**
...
* [purple](https://github.com/erickochen/purple) ⭐ 708 | 🐛 4 | 🌐 Rust | 📅 2026-09-22 — SSH client TUI with built-in Hetzner Cloud sync. Auto-discovers servers, syncs metadata (location, type, image, status), provider tags and stale host detection.
...
* [terraform-hcloud-kube-hetzner](https://github.com/kube-hetzner/terraform-hcloud-kube-hetzner) ⭐ 3,932 | 🐛 8 | 🌐 HCL | 📅 2026-09-14 — A highly optimized and auto-upgradable, HA-default & Load-Balanced, Kubernetes cluster powered by k3s-on-MicroOS and deployed for peanuts on Hetzner Cloud 🤑 🚀
* **[Terraform Provider](https://github.com/hetznercloud/terraform-provider-hcloud) ⭐ 740 | 🐛 58 | 🌐 Go | 📅 2026-09-23 — Official Hetzner Cloud Terraform Provider**
* [hcloud-kubernetes](https://github.com/hcloud-k8s/terraform-hcloud-kubernetes) ⭐ 709 | 🐛 12 | 🌐 HCL | 📅 2026-09-26 — Terraform Module to Deploy a Highly Available, Production-Ready Talos Kubernetes Cluster on Hetzner Cloud.
...
* [Coder Template](https://github.com/ntimo/coder-hetzner-cloud-template) ⭐ 29 | 🐛 3 | 🌐 HCL | 📅 2024-04-27 — A Terraform template for [Coder](https://github.com/coder/coder) ⭐ 16,707 | 🐛 1,156 | 🌐 Go | 📅 2026-09-26 to setup a cloud instance as dev environment with or without VS Code.
...
* [Algo VPN](https://github.com/trailofbits/algo) ⭐ 30,394 | 🐛 77 | 🌐 Python | 📅 2026-09-23 — Algo VPN is a set of Ansible scripts that simplify the setup of a personal Wireguard and IPSEC VPN.
* **[Hetzner Cloud Ansible Collection](https://github.com/ansible-collections/hetzner.hcloud) ⭐ 153 | 🐛 17 | 🌐 Python | 📅 2026-09-23 — Ansible Collection for Hetzner Cloud. Part of Ansible Community Distribution (ACD).**
...
* [janosmiko/hetzner-k3s](https://github.com/janosmiko/hetzner-k3s) ⭐ 37 | 🐛 1 | 🌐 Go | 📅 2023-11-10 — CLI tool to install and manage production grade lightweight Kubernetes (k3s) clusters in 5 minutes in Hetzner. Features: Hetzner CCM and CSI support, HA, Multiple Worker Pools, Autoscaling etc.
* **[External DNS Hetzner Webhook](https://github.com/hetzner/external-dns-hetzner-webhook) ⭐ 25 | 🐛 10 | 🌐 Go | 📅 2026-09-25 — This webhook provides integration between External DNS and the Hetzner DNS API to manage records automatically.**
* [karpenter-provider-hetzner](https://github.com/paperclipinc/karpenter-provider-hetzner) ⭐ 20 | 🐛 26 | 🌐 Go | 📅 2026-09-19 — Karpenter node autoprovisioning for Hetzner Cloud: launches the cheapest server that fits pending pods and consolidates idle nodes. By [Paperclip.inc](https://paperclip.inc/blog/karpenter-hetzner).
* [gardener-extension-provider-hcloud](https://github.com/23technologies/gardener-extension-provider-hcloud) ⭐ 18 | 🐛 22 | 🌐 Go | 📅 2026-09-25 — Gardener Extension for Hetzner Cloud provider.
...
* [VitoDeploy](https://github.com/vitodeploy/vito) ⭐ 3,243 | 🐛 19 | 🌐 PHP | 📅 2026-09-21 — Vito is a self-hosted web application that helps you to manage your servers and deploy your PHP applications into production servers without a hassle.
...
* [DevPod Provider](https://github.com/mrsimonemms/devpod-provider-hetzner) ⭐ 49 | 🐛 3 | 🌐 Go | 📅 2026-03-26 — Run [DevPod](https://github.com/loft-sh/devpod) ⭐ 15,238 | 🐛 53 | 🌐 Go | 📅 2025-11-14 cloud development environments on Hetzner.
